...
<div class="privacy">
    ...
    <p>SoMoTech ("us", "we", or "our") operates the SoMo-Tech.com website (the "Service").</p>
    ...
    <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of
        ...
        Privacy Policy have the same meanings as in our Terms and Conditions, accessible from SoMo-Tech.com</p>
    ...
    <p>SoMoTech uses the collected data for various purposes:</p>
    <ul>
    ...
    <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to
        that transfer.</p>
    <p>SoMoTech will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
    ...
    <p>SoMoTech may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
    <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of SoMoTech</li>
    ...
    <ul>
        <li>By email: Hamidisubhi@gmail.com</li>
