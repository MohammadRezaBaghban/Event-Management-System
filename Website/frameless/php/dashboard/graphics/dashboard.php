        ...
        <div class="container-fluid">
            <div id="navigation">
                ...
                <ul class="navigation-menu">
                    ...
                    <li><a href="" data-toggle="modal" data-target="#myModal"><i class="mdi mdi-view-dashboard"></i><span>Top Up</span></a></li>
...
<div class="wrapper">
    ...
    max-width: 800px;">
        ...
        <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: block;">
