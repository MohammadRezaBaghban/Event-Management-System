...
<div class="wrapper-page">
    <div class="text-center">
        <a href="./index.php?page=home" class="logo"><span>HighLands Halloween <span>Festival</span></span></a>
    </div>
        ...
        <div class="p-20">
            <form class="form-horizontal m-t-20" action="./index.php?page=change" method="POST">
                ...
                <div class="form-group text-center m-t-20 mb-0">
                    <div class="col-xs-12">
                        <button class="btn btn-custom btn-bordred btn-block waves-effect waves-light" type="submit" name="ForgotPassword" >Send Email</button>
                    </div>
                </div>
